            ...
            <form method="POST" action="{{ route('task.update', $task->id) }}">
                ...
                <div class="text-[#E4DCCF]">
                    <div class="">
                        ...
                        <textarea id="task" name="task" rows="5" maxlength="300" value="{{ $task->task }}" class="mb-3 mt-1 block w-full px-2 py-1.5 border-[#292C6D] border-2 rounded-md text-sm shadow-sm placeholder-gray-400 focus:outline-none focus:border-[#EA5455] focus:ring-1 focus:ring-[#EA5455] text-[#002B5B] font-mono bg-[#F9F5EB]" required>{{ $task->task }}</textarea>
